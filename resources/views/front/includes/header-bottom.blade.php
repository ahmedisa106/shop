                            ...
                            <div id="verticalmenu" class="verticalmenu" role="navigation">
                                <ul class="menu level1">
                                    <li class="item  parent"><a href="#" title="Laptops &amp; Accessories"><i
                                            ...
                                            &amp; Accessories</a><span
                                            class="show-sub fa-active-sub"></span><span class="menu-sub-title">Dell. HP, Macbook, Alienware and etc...</span>
                                        <div class="dropdown-menu" style="width:222px">
                                            <ul>
                                                <li class="item "><a href="#" title="Macbook Pro">Macbook
                                                        Pro</a></li>
                                                <li class="item  parent"><a href="#" title="Laptop Thinkpad">Laptop
                                                        Thinkpad</a><span class="show-sub fa-active-sub"></span>
                                                ...
                                                <li class="item "><a href="#" title="EliteBook">EliteBook</a>
                                                </li>
                                                <li class="item "><a href="#" title="Lenovo Yoga">Lenovo
                                                        Yoga</a></li>
                                                <li class="item "><a href="#" title="Probook">Probook</a></li>
                                                ...
                                                <li class="item "><a href="#" title="HP Pavilion">HP
                                                        Pavilion</a></li>
                                                <li class="item "><a href="#" title="HDD Box - Caddy Bay">HDD
                                                        Box - Caddy Bay</a></li>
                                    ...
                                    <li class="item  parent group"><a href="#" title="Electronics"><i
                                            ...
                                            class="show-sub fa-active-sub"></span><span class="menu-sub-title">Blender , iron, Vacuum cleaner ...</span>
                                    ...
                                    <li class="item  parent group"><a href="#"
                                            ...
                                            class="show-sub fa-active-sub"></span><span class="menu-sub-title">Speaker, Headphone, Soundcard ...</span>
                                        <div class="dropdown-menu" style="width:922px">
                                            <ul>
                                    ...
                                    <li class="item  parent group"><a href="#" title="Smartphone &amp; Tablets"><i
                                                class="hasicon nov-icon"
                                            ...
                                            &amp; Tablets</a><span class="show-sub fa-active-sub"></span><span
                                                    ...
                                                    <div class="menu-content">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-12">
                                                                ...
                                                                <ul>
                                                                    <li class="item "><a href="#" title="iPad">iPad</a>
                                                                    </li>
                                                                    <li class="item  parent"><a href="#"
                                                                    ...
                                                                    <li class="item "><a href="#" title="Asus">Asus</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            <div class="col-lg-3 col-12">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="item "><a href="#" title="Sony">Sony</a>
                                                                    </li>
                                                                    <li class="item "><a href="#"
                                                                    ...
                                                                    <li class="item "><a href="#"
                                                                            ...
                                                                            (Zenfone)</a></li>
                                                                    <li class="item "><a href="#" title="HTC">HTC</a>
                                                                    </li>
                                                                    <li class="item "><a href="#"
                                    ...
                                    <li class="item "><a href="#" title="Gaming Gear"><i
                                            ...
                                            Gear</a><span
                                            class="menu-sub-title">Mouse, Headphone, Console ...</span></li>
                                    ...
                                    <li class="item "><a href="#" title="Camera"><i class="hasicon nov-icon"
                                            ...
                                            class="menu-sub-title">Lorem ipsum dolor sit amet quam</span></li>
                                    <li class="item "><a href="#" title="Monitor &amp; Television"><i
                                            ...
                                            &amp; Television</a><span class="menu-sub-title">Sony BRAVIA, SamSung, TV 4K ...</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <div class="dropdown-menu" style="width:200px">
                                            <ul class="">
                                                <li class="item "><a href="?home=home_1" title="Homepage 1">Homepage
                                                        1</a></li>
                                                <li class="item "><a href="?home=home_2" title="Homepage 2">Homepage
                                                        2</a></li>
                                                <li class="item "><a href="?home=home_3" title="Homepage 3">Homepage
                                                        3</a></li>
                                                <li class="item "><a href="?home=home_4" title="Homepage 4">Homepage
                                                        4</a></li>
                                                <li class="item "><a href="?home=home_5" title="Homepage 5">Homepage
                                                        5</a></li>
                                                <li class="item "><a href="?home=home_6" title="Homepage 6">Homepage
                                                        6</a></li>
                                                <li class="item "><a href="?home=home_7" title="Homepage 7">Homepage
                                                        7</a></li>
                                                <li class="item "><a href="?home=home_8" title="Homepage 8">Homepage
                                                        8</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul class="col">
                                                                        <li><a href="/savemart/en/3-clothing">Category
                                                                                Layout Grid</a></li>
                                                                        <li><a href="#">Category Layout List</a>
                                                                        </li>
                                                                        <li><a href="#">Category Left
                                                                                Sidebar</a></li>
                                                                        <li><a href="#">Category Right
                                                                                Sidebar</a></li>
                                                                        <li><a href="#">Category No Sidebar</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </li>
                                                            ...
                                                            <li class="item col-lg-3 col-md-3 html"><span
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul class="col">
                                                                        ...
                                                                        <li><a href="#" title="OPPO ">OPPO </a>
                                                                        </li>
                                                                        <li><a href="#" title="Sony">Sony</a>
                                                                        </li>
                                                                        <li><a href="#"
